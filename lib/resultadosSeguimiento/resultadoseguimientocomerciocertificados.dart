...
class ResultadoSeguimientoComercioCertificados extends StatelessWidget {
  final String informacion;
  final String iIDSolicitud;
  final int iIDAnioFiscal;
  final String cTipo;

  const ResultadoSeguimientoComercioCertificados({
    Key? key,
          ...
          children: [
            Card(
              ...
              child: const ListTile(
                title: Center(
                  child: Text(
                    'RESULTADO DEL SEGUIMIENTO CERTIFICADOS',
                    style: TextStyle(
