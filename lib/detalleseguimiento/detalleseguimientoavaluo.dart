...
class DetallesSeguimientoAvaluo extends StatelessWidget {
  final String detalles;

  const DetallesSeguimientoAvaluo({Key? key, required this.detalles})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, IconData> iconos = {
      ...
      'ni ni-credit-card': Icons.credit_card,
      'ni ni-book-bookmark': Icons.bookmark_add,
      'ni ni-fat-remove': Icons.remove_circle,
      'ni ni-file': Icons.file_copy
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      ...
                      color: dato['cTema'] == 'badge-success'
                          ? Colors.green
                          : dato['cTema'] == 'badge-primary'
                              ? Colors.blue
                              : Colors.yellow,
                    ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Fecha: ${dato['cFechaSeguimiento']} - ${dato['cHoraSeguimiento']}',
                        ),
                      ],
                    ),
                  ),
