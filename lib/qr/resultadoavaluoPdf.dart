...
import 'avaluoqr.dart';

class ResultadoAvaluoPdf extends StatefulWidget {
  final String pdf;

  const ResultadoAvaluoPdf({super.key, required this.pdf});

  @override
  State<ResultadoAvaluoPdf> createState() => _ResultadoAvaluoPdfState();
}

class _ResultadoAvaluoPdfState extends State<ResultadoAvaluoPdf> {
