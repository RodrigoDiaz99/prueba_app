...
class Normatividad extends StatefulWidget {
  const Normatividad({Key? key}) : super(key: key);

  @override
  State<Normatividad> createState() => _NormatividadState();
}

class _NormatividadState extends State<Normatividad> {
              ...
              children: [
                InAppWebView(
                  ...
                  initialUrlRequest: URLRequest(
                      url: WebUri("https://www.insejupy.gob.mx/Normatividad")),
