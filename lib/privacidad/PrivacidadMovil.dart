...
class PrivacidadMovil extends StatefulWidget {
  const PrivacidadMovil({Key? key}) : super(key: key);

  @override
  State<PrivacidadMovil> createState() => _PrivacidadMovilState();
  // _ContactoState createState() => _ContactoState();
}

class _PrivacidadMovilState extends State<PrivacidadMovil> {
              ...
              children: [
                InAppWebView(
                  ...
                  initialUrlRequest: URLRequest(
                      url: WebUri(
                          "https://consulta.insejupy.gob.mx/politicas/movil")),
